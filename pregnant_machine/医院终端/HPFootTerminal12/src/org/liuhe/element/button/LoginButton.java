...
public class LoginButton extends JButton{
	...
	private Font gen_font = new Font("黑体", Font.PLAIN+Font.BOLD, 40);
	...
	protected void paintComponent(Graphics g) {
        ...
        g2d.fill(r2d);
        g2d.setPaint(p1);
        g2d.drawRoundRect(0, 0, width - 1, height - 1, 20, round);
        g2d.setPaint(p2);
        g2d.drawRoundRect(1, 1, width - 3, height - 3, 18, round-2);
